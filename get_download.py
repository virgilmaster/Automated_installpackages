...
def get_result(aliyun_domain,tsinghua_domain,douban_domain,ustc_domain):
...
def downloading_resource():
    task_ali = os.system()
    task_ustc = os.system()
    task_tsinghua = os.system()
    task_douban = os.system()
...
if __name__ == '__main__':
    ...
    get_result(aliyun_domain,tsinghua_domain,douban_domain,ustc_domain)
